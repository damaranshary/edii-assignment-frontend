  ...
  return (
    <main className="mx-auto flex min-h-screen w-[600px]">
      <form
        ...
        className="my-10 flex h-fit w-full flex-col rounded-2xl border-gray-200 bg-white px-4 pb-8 pt-5 shadow-md sm:border sm:px-10 sm:pt-8 gap-y-4"
      >
        <h1 className="text-center text-2xl font-semibold">Biodata</h1>
        ...
        <div className="flex flex-col gap-y-2">
          ...
          <select
            className="rounded-xl border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-primary"
            id="ready_to_be_placed"
            {...register("ready_to_be_placed")}
          >
        ...
        <button
          type="submit"
          className="mt-2 w-96 self-center rounded-full bg-primary px-5 py-2 text-white"
        >
          <span>Submit</span>
        </button>
      </form>
